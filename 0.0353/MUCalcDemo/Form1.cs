    ...
    public partial class Form1 : Form
    {
        ...
        private DOSELoad doseFileLoad()
        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                if (openFileDialog.FileName != "")
                {
                    doseload = new DOSELoad(openFileDialog.FileName);
                }
            }
        ...
        private void countMUButton_Click(object sender, EventArgs e)
        {
            ...
            double[,] beamParams = new double[this.numberOfBeams, 6];
        ...
        private void testbutton_Click(object sender, EventArgs e)
        {
            ...
            {
                int i = 0;
                string test = "Nazwa Dawka(Gy) SSD(mm) Gl(mm) Gl_rad(mm)" + Environment.NewLine;
            ...
            //    this.SSD[doseload.beamNumber - 1] = Convert.ToDouble(doseData[0][2].Replace('.', ',')) / 10;
            //    this.SSDDepth[doseload.beamNumber - 1] = Convert.ToDouble(doseData[0][4].Replace('.', ',')) / 10;
            //}
        }
    }
}
