...
namespace MUCalcDemo
{
    public partial class Form1 : Form
    {
        ...
        private void testbutton_Click(object sender, EventArgs e)
        {
            ...
            List<string> doseTags = doseload.tagName("30051027");
            List<double> doseData = doseload.tagValue("30051028");
            ...
            if (doseload.success)
            {
                ...
                foreach (string data in doseTags)
                {
                    test += data + ": " + doseData[i] + Environment.NewLine;
                    i++;
                }
